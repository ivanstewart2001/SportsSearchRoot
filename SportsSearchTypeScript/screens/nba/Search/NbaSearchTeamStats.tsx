...
import { teamStatsHandler } from "../../../store/nba"
import { AppDispatch, RootState } from "../../../store/store"
import LoadingOverlay from "../../../components/UI/LoadingOverlay"
import { TextInput } from "react-native-gesture-handler"
import TeamStats from "../../../components/nba/TeamStats"
import { NbaTeamStatsParams } from "../../../types/redux/nba"

function NbaSearchTeamStats() {
    ...
    function getPlayer() {
        ...
        setSubmitted(true)
        const params:NbaTeamStatsParams = {
            teamAbbreviation: selectedTeam,
            year,
            dataFormat: selectedFormat
        }

        dispatch(teamStatsHandler(params))
    ...
    if (data.teamStats && data.teamStats.length === 0 && submitted && !loading) {
        return (
...
export default NbaSearchTeamStats