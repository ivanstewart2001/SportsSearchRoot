...
import { rosterStatsHandler, teamStatsHandler } from "../../../store/nba"
import { AppDispatch, RootState } from "../../../store/store"
import LoadingOverlay from "../../../components/UI/LoadingOverlay"
import { TextInput } from "react-native-gesture-handler"
import TeamStats from "../../../components/nba/TeamStats"
import { NbaRosterStatsParams, NbaTeamStatsParams } from "../../../types/redux/nba"
import RosterStats from "../../../components/nba/RosterStats"
...
function NbaSearchRosterStats() {
    ...
    const [selectedFormat, setSelectedFormat] = useState('TOTALS')
    ...
    function getPlayer() {
        ...
        setSubmitted(true)
        const params:NbaRosterStatsParams = {
        ...
        dispatch(rosterStatsHandler(params))
    ...
    if (!submitted) {
        return (
            <ScrollView style={styles.container}>
                ...
                >
                    <Picker.Item label='TOTAL' value='TOTALS' />
    ...
    if (data.rosterStats && data.rosterStats.length === 0 && submitted && !loading) {
        return (
            <View style={styles.container}>
                <Text>Sorry! Could not find stats for given year and team. Please try a different year and or team.</Text>
    ...
    return (
        <View style={styles.container}>
            ...
            <RosterStats data={data.rosterStats} />
        </View>
